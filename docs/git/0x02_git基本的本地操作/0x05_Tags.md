...
更难得的是，它们并**不会随着新的提交而移动**。你也不能切换到某个标签上面进行修改提交，它就像是提交树上的一个锚点，标识了某个特定的位置。
...
![image-20230210223038543](https://muyids.oss-cn-beijing.aliyuncs.com/img/image-20230210223038543.png)
